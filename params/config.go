...
var (
	...
	MainnetTrustedCheckpoint = &TrustedCheckpoint{
		SectionIndex: 722,
		SectionHead:  common.HexToHash("0xc8c61619be0987cc4bca29cf1b59e9faf538aa140c8639a5d2d69b39267a3d61"),
		CHTRoot:      common.HexToHash("0x33e9779225c2e6f472168f3da712963c80075521f304c7cc0cdd97e0c4b5c240"),
		BloomRoot:    common.HexToHash("0xc6740deabceabd06ff53efff399d6768173de6ae685ad707fe4a8e45aedfd969"),
	}
	...
	TestnetChainConfig = &ChainConfig{
		...
		PetersburgBlock:     big.NewInt(4),
		IstanbulBlock:       big.NewInt(4),
		BerlinBlock:         big.NewInt(10637000),
		LondonBlock:         big.NewInt(10637000),
		ShanghaiTime:        newUint64(1689393614),
		Clique: &CliqueConfig{
			Period: 15,
			Epoch:  30000,
		},
...
type ChainConfig struct {
	...
	//max expired time convert into  height
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v OldChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v Petersburg: %v Istanbul: %v ChainIDBlock:%v PBFTBlock:%v CustomizeDIDHeight:%v MaxExpiredHeight:%v Engine: %v DynamicArbiterHeight: %v}",
		c.ChainID,
		c.OldChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
